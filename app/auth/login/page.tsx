      ...
      <AnimatePresence mode="wait">
        {loginSuccess ? (
          ...
          >
            ...
            <p className="text-gray-600 mb-6">Selamat datang kembali di sistem kami.</p>
                ...
                <motion.div variants={containerVariants} className="space-y-5">
                  <motion.div variants={itemVariants} className="space-y-1.5">
                    ...
                    <motion.input
                      ...
                      name="email"
                      required
                      className="w-full px-4 py-3 text-gray-700 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all placeholder-gray-400"
